	...
	private void initializeButtonListeners() {
		...
		leftArrow.setOnClickListener(new OnClickListener() {
			public void onClick(View arg0) {
				...
				int resID = getResources().getIdentifier(position, "drawable",
						"com.shawnhanna.shop");
				layout.setBackgroundResource(resID);
			}
		});
		...
		/*
		 * upArrow.setOnClickListener(new OnClickListener() { public void
		 * onClick(View arg0) { position = mapping.get(position).up; info =
		 * mapping.get(position); position = info.name; if(info.hasUp){
		 * upArrow.setVisibility(View.VISIBLE); } else{
		 * upArrow.setVisibility(View.GONE); } int resID =
		 * getResources().getIdentifier(position, "drawable",
		 * "com.shawnhanna.shop"); layout.setBackgroundResource(resID); } });
		 */
	}
