...
public class BarcodeActivity extends CaptureActivity {
	...
	private void itemAlreadyChecked(Item item) {
		...
		alertDialogBuilder.setMessage("Item already placed in cart")
				.setCancelable(false)
	...
	private void addItemToChecked(Item item) {
		...
		AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(this);
		alertDialogBuilder.setTitle("Scan Results");
		alertDialogBuilder.setMessage(item.getShortName() + " placed in cart.")
				.setCancelable(false)
				.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface dialog, int id) {
	...
	private void itemNotRecognized(String barcode) {
		...
		alertDialogBuilder.setMessage("Item not found in database")
				.setCancelable(false)
				.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface dialog, int id) {
