...
final class DecodeHandler extends Handler {
  ...
  DecodeHandler(CaptureActivity activity, Map<DecodeHintType,Object> hints) {
    ...
    WindowManager manager = (WindowManager) activity.getApplication().getSystemService(Context.WINDOW_SERVICE);
  ...
  private static Bitmap toBitmap(LuminanceSource source, int[] pixels) {
    ...
    //if(width < height){
    //	bitmap.setPixels(pixels, 0, stride, x, y, width, height)
